...
const CreateTemplateModal = ({ data }: CreateTemplateModalProps) => {
                ...
                <DialogHeader className='pt-8 px-6'>
                    <DialogTitle className='text-2xl text-center font-bold'>
                        <div className='flex items-center justify-center'>
                            ...
                            <span>Create a New Bot Template <em>{data?.server?.name}</em></span>
                        </div>
                    </DialogTitle>
                    <DialogDescription className='text-center text-zinc-300'>
                        <div>Share your character with the world!</div> 
                    </DialogDescription>
                </DialogHeader>
